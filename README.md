...
- [sql is the thing used to interact with the databse ] Explain the difference between `Relational Databases` and `SQL`.

- [ better accessibility] Why do tables need a `primary key`?

- [ foreign key ] What is the name given to a table column that references the primary key on another table.

- [ a joining table ] What do we need in order to have a _many to many_ relationship between two tables.
